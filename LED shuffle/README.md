This project is one of the early C projects. In this project, we connected resistors to LEDs and connected the breadboard to an MCU (MicroControlling Unit) which we 
