C code that is a representation of the Drag Race Christmas Tree. The program is coded to check 3 button inputs. 2 of them are where cars are supposed to be. When 2
